...
const RussiaFlag = forwardRef<HTMLSpanElement, IconProps>((allProps, ref) => {
    ...
    <IconWrapper
      ...
      icon={
        <svg
          ...
          {...props}
        >
          <path fill={'url(#russia-flag__svg__a)'} d={'M0 0h24v24H0z'} />
          <defs>
            <pattern
              id={'russia-flag__svg__a'}
              width={1}
              height={1}
              patternContentUnits={'objectBoundingBox'}
            >
              <use xlinkHref={'#russia-flag__svg__b'} transform={'scale(.01389)'} />
            </pattern>
            <image
              xlinkHref={
