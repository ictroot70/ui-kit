...
const UkFlag = forwardRef<HTMLSpanElement, IconProps>((allProps, ref) => {
    ...
    <IconWrapper
      ...
      icon={
        <svg
          ...
          {...props}
        >
          <path fill="url(#uk-flag_svg__a)" d="M0 0h24v24H0z" />
          <defs>
            <pattern
              id="uk-flag_svg__a"
              width={1}
            ...
            >
              <use xlinkHref="#uk-flag_svg__b" transform="scale(.01389)" />
            </pattern>
            <image
